...
//	}
	...
	private void viderRessources() {
		...
		for (int i = 0; i < lRessource.size(); i++) {
			...
			Pair<Integer, Integer> ident2 = new Pair<Integer, Integer>(id_ressource, type_ressource);
			boolean test2 = ident.equals(ident2);
			boolean test = listeEDT.containsKey(ident);
