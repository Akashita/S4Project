...
public class PanelInfoRessource extends JPanel{
	...
	private JPanel panelTitreInfoColonne(String titre, String info1, String info2) {
		JPanel panel = new JPanel();
		panel.setBackground(couleurFond);
		...
		gc.gridx = 0;
		gc.gridy = 0;
		panel.add(labelTitreColonne(titre), gc);
		gc.gridy ++;
		panel.add(panelInfoColonne(info1, info2), gc);
	
		return panel;
	}
	
	private JPanel panelInfoColonne(String col1, String col2) {
		JPanel panel = new JPanel();
		panel.setBackground(couleurFond);
		panel.setLayout(new GridBagLayout());
		GridBagConstraints gc = new GridBagConstraints();
		...
		gc.gridx = 0;
		gc.gridy = 0;
		panel.add(labelInfoColonne(col1), gc);
		gc.gridx = 1;
		panel.add(labelInfoColonne(col2), gc);
		return panel;
	}
