...
//	}
	...
	public static void insertionSalarie(int numSalarie, int idA) throws SQLException{
		String sql = "INSERT INTO Participes(numSalarie,idA) VALUE('" + numSalarie+ "' , '"+idA+"');";
			try{
				 connection();
				 Statement stmt = getCon().createStatement();
	...
	public static void insertionSalle(int numero, int idA) throws SQLException{
		String sql = "INSERT INTO Participes(numSalarie, code, numero, idA) VALUE('"+numero+"' ,  '"+idA+"');";
			try{
				 connection();
				 Statement stmt = getCon().createStatement();
				 stmt.executeUpdate(sql);
	...
	public static void insertionCalcul(int code, int idA) throws SQLException{
		String sql = "INSERT INTO Participes(numSalarie, code, numero, idA) VALUE('"+code+"' , '"+idA+"');";
			try{
				 connection();
				 Statement stmt = getCon().createStatement();
				 stmt.executeUpdate(sql);
