...
public class FenetreDebugTicket extends JFrame{
	...
	public FenetreDebugTicket(Entreprise entreprise,int type){	
		this.entreprise = entreprise;
		this.type = type;
		
		this.setTitle("gestionBDD ticket");
		...
		PanelDebugActionBarre panelAction = new PanelDebugActionBarre(entreprise, this, PanelDebugActionBarre.TICKET);
